 ...
 * 
 * Description: 
 *      Class for the Shape Rectangle. This is a subclass of the abstract class Shape.cs
 *      -Create an Object of class Rectangle and save its dimensions.
...
namespace Lab2A
{
    ...
    {
        public double widthOfShape;
        public double heightOfShape;

        /// <summary>
        /// Constructor for Object of type Rectangle.
        /// Assign its Type to Rectangle upon creation.
        /// </summary>
        ...
        /// <summary>
        /// Prompts the user for dimensions of this Rectangle.
        /// </summary>
        public override void SetData()
        {
            ...
            if (input1 == input2)
                throw new ArgumentException("The dimensions cannot be equal in this shape!");
        }
        ...
        public override string ToString() => $"{Type} - [Base = {widthOfShape}] [Height = {heightOfShape}] [Area  = {Math.Round(CalculateArea(),2)}]";
